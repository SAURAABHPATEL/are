...
$.ajax({
    ...
    if (firstGame && firstGame.stage === list_orders[0].period) {
      ...
      myModal_result_Period.innerHTML = "Period : 5min " + firstGame.stage;
  ...
  function alertBox(join, addText) {
    ...
    switch (join) {
      case "x":
        ...
        break;
      case "t":
        selectCss("colorviolet", "#61a9ff", addText);
        break;
      case "d":
        selectCss("colorred", "#61a9ff", addText);
        break;
      case "l":
        selectCss("colorbig", "#61a9ff", addText);
        break;
      case "n":
      ...
      default:
        if (join % 2 == 0) {
          selectCss(`color${join}`, "#61a9ff", addText);
        } else {
