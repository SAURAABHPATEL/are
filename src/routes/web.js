...
const initWebRouter = (app) => {
    ...
    router.get('/slotmg', middlewareController, homeController.slotmgPage);
    router.get('/slotjdb', middlewareController, homeController.slotjdbPage);
    router.get('/slotcq9', middlewareController, homeController.slotcq9Page);
    router.get('/slotevo', middlewareController, homeController.slotevoPage);
    router.get('/lottery', middlewareController, homeController.lotteryPage);
    ...
    router.get('/rummy', middlewareController, homeController.rummyPage);
    ...
    router.post('/api/webapi/myTeam', middlewareController, userController.listMyTeam); // register
